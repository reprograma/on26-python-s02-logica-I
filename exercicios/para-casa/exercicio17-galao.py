...
quant_galao_comprar = math.ceil(litros_por_tamanho / galao_em_litros) 
print( "A quantidade de galões para comprar é de:" , quant_galao_comprar)

valor_compra_galao = quant_galao_comprar * valor_lata
print( "O valor a ser pago é de: $", valor_compra_galao)